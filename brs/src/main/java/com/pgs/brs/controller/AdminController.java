...
import com.pgs.brs.repository.AdminRepository;
...
public class AdminController {
	...
	public Boolean adminLogin(@RequestBody Admin admin) {
		Optional<Admin>  verifiedAdmin = adminRepository.findById(admin.getUsername());
		if(verifiedAdmin.isPresent()) {
			return Objects.equals(admin.getPassword(), verifiedAdmin.get().getPassword());
		}else {
			return false;	
		}
